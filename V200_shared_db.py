...
CREATE TABLE IF NOT EXISTS workspace_configs(workspace_id TEXT PRIMARY KEY,revision INTEGER NOT NULL DEFAULT 0,items_json TEXT NOT NULL DEFAULT '[]',updated_at INTEGER NOT NULL,updated_by TEXT NOT NULL DEFAULT 'system');
CREATE TABLE IF NOT EXISTS custom_field_definitions(field_key TEXT NOT NULL,workspace_id TEXT NOT NULL,label TEXT NOT NULL,field_type TEXT NOT NULL DEFAULT 'text',sort_order INTEGER NOT NULL DEFAULT 0,enabled INTEGER NOT NULL DEFAULT 1,created_at INTEGER NOT NULL,updated_at INTEGER NOT NULL,PRIMARY KEY(workspace_id,field_key));
CREATE TABLE IF NOT EXISTS contact_custom_values(contact_id TEXT NOT NULL,field_key TEXT NOT NULL,value_json TEXT NOT NULL DEFAULT 'null',updated_at INTEGER NOT NULL,updated_by TEXT NOT NULL,PRIMARY KEY(contact_id,field_key),FOREIGN KEY(contact_id) REFERENCES contacts(contact_id));
CREATE TABLE IF NOT EXISTS legacy_id_mappings(legacy_system TEXT NOT NULL,legacy_id TEXT NOT NULL,entity_type TEXT NOT NULL,entity_id TEXT NOT NULL,created_at INTEGER NOT NULL,PRIMARY KEY(legacy_system,legacy_id,entity_type));
CREATE TABLE IF NOT EXISTS migration_batches(batch_id TEXT PRIMARY KEY,source_path TEXT NOT NULL,mode TEXT NOT NULL,status TEXT NOT NULL,report_json TEXT NOT NULL DEFAULT '{}',created_at INTEGER NOT NULL,finished_at INTEGER);
CREATE TABLE IF NOT EXISTS migration_issues(issue_id INTEGER PRIMARY KEY AUTOINCREMENT,batch_id TEXT NOT NULL,severity TEXT NOT NULL,legacy_id TEXT,message TEXT NOT NULL,details_json TEXT NOT NULL DEFAULT '{}');
"""
...
class Database:
    ...
    def init(self):
        ...
        try:
            ...
            c.execute("INSERT OR IGNORE INTO workspace_configs(workspace_id,revision,items_json,updated_at,updated_by) VALUES('default',0,'[]',?,'system')",(t,))
            c.execute('INSERT OR IGNORE INTO schema_migrations VALUES(?,?,?)',(201,'V134 compatibility and custom fields',t))
