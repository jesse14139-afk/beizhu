...
APP_VERSION='129.0.0-alpha2'; SCHEMA_VERSION=2
...
def capabilities():return {'snapshotSyncV1':True,'syncStatusV1':True,'factsRevisionV1':True,'serverAggregateV1':True,'aggregateHashV1':True,'epochFenceV1':True}
...
def main():
 init_db();print('='*70);print('聚宝盆客户信息管理系统 - 本地同步服务 v'+APP_VERSION);print(f'服务地址：http://{HOST}:{PORT}');print(f'数据库：{DB_PATH}');print('v129 Alpha 2：服务端影子聚合、SHA-256/Revision 围栏；旧接口及本地回退完整保留');print('='*70);ThreadingHTTPServer((HOST,PORT),H).serve_forever()
