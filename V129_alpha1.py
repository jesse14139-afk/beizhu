...
APP_VERSION='129.0.0-alpha1'; SCHEMA_VERSION=1
...
def main():
 init_db();print('='*70);print('聚宝盆客户信息管理系统 - 本地同步服务 v'+APP_VERSION);print(f'服务地址：http://{HOST}:{PORT}');print(f'数据库：{DB_PATH}');print('v129：原子快照、服务端确认、事实版本、Epoch 围栏；旧接口完整保留');print('='*70);ThreadingHTTPServer((HOST,PORT),H).serve_forever()
