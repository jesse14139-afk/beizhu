// ==UserScript==
// @name         聚宝盆 v129 Alpha 1
// @namespace    wa-remark-helper
// @version      129.0.0-alpha1
// @description  v129 Alpha 1：原子快照对账、Epoch 围栏、服务端确认序号及汇总任务看门狗；兼容 v128 服务端。
...
(function () {
  ...
  var V128_SYNC_VERSION = "129.0.0-alpha1";
...
function getPanelDisplayData() {
    ...
    async function v129UploadSnapshot(sourceId,sourceName,snapshot) {
      ...
      var ack=Number(res.data&&res.data.serverAckSeq)||seq;
