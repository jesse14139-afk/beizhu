// ==UserScript==
// @name         聚宝盆客户信息管理系统 v130 独立Dashboard
// @namespace    wa-remark-helper
// @version      130
// @description  v130：新增独立 Dashboard 入口，复用管理面板与原同步协调机制；本源可编辑、他源及聚合主记录只读。
...
(function () {
  ...
  // v130：本地独立 Dashboard 模式。该页面只挂载管理面板，不启动任何渠道 DOM 采集。
  var STANDALONE_DASHBOARD_MODE = ((location.hostname === "127.0.0.1" || location.hostname === "localhost") && location.port === "8765" && location.pathname === "/dashboard");
